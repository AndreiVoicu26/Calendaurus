...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost;Database=CalendaurusDB;Trusted_Connection=True;Encrypt=false;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PracticalLessonEvent>(entity =>
        {
            ...
            entity.HasOne(d => d.Professor).WithMany(p => p.PracticalLessonEvents)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<TheoreticalLessonEvent>(entity =>
        {
            ...
            entity.HasOne(d => d.Professor).WithMany(p => p.TheoreticalLessonEvents)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_TheoreticalLessonEvent_Professor");
